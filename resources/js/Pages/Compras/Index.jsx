...
export default function Index({ compras, filters }) {
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        router.get(route('compras.index'), { search, fecha_inicio: fechaInicio, fecha_fin: fechaFin }, {
            preserveState: true,
        });
    };
                            ...
                            <div className="bg-gray-50 px-4 py-3 border-t border-gray-200 sm:px-6">
                                <div className="flex justify-between items-center">
                                    <div className="text-sm text-gray-700">
                                        Mostrando <span className="font-medium">{compras.from}</span> a{' '}
                                        <span className="font-medium">{compras.to}</span> de{' '}
                                        <span className="font-medium">{compras.total}</span> resultados
                                    </div>
                                    <div className="flex gap-2">
