...
export default function Index({ materiales, filters }) {
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        router.get(route('materiales.index'), { search }, {
            preserveState: true,
        });
    };
                                    ...
                                    {materiales.data && materiales.data.length > 0 ? (
                                        materiales.data.map((material) => (
                                            <tr key={material.id} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <span className={`text-sm font-semibold ${material.stock < 10 ? 'text-red-600' : 'text-gray-900'}`}>
                                                        {material.stock}
                                                    </span>
                                                </td>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    <div className="flex justify-end gap-2">
                                                        <Link
                                                            href={route('materiales.show', material.id)}
