...
export default function Edit({ material }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        precio_dia_compra: material.precio_dia_compra || '',
        precio_dia_venta: material.precio_dia_venta || '',
        ...
        <AuthenticatedLayout
            header={
                <div className="flex justify-between items-center">
                    <h2 className="text-xl font-semibold text-gray-800">Editar Material</h2>
                    <Link
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            <div className="flex justify-end gap-3">
                                ...
                                >
                                    {processing ? 'Actualizando...' : 'Actualizar Material'}
                                </button>
                            </div>
                        </form>
                    </div>
